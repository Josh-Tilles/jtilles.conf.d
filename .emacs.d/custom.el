(custom-set-variables
 ...
 '(el-get-sources (quote ((:name package :post-init nil) (:name cl-lib :type builtin) (:name packed :checkout "0.3.3") (:name smotitah :type github :pkgname "MerelyAPseudonym/smotitah") (:name ibuffer-vc :checkout "0.6" :type elpa) (:name helm :checkout "v1.5.2") (:name smex :type elpa :checkout "2.0") (:name ido-vertical-mode :type elpa :repo ("MELPA" . "http://melpa.milkbox.net/packages/")) (:name s :type elpa :checkout "1.5.0") (:name dash :type elpa :checkout "1.3.2") (:name projectile :checkout "v0.9.1") (:name undo-tree :repo ("gnu" . "http://elpa.gnu.org/packages/") :type elpa :version "0.6.3") (:name evil :type elpa :checkout "1.0.3") (:name ido-ubiquitous :checkout "v1.6") (:name gitconfig-mode :type elpa) (:name gitignore-mode :type elpa) (:name git-commit-mode :type elpa) (:name xml-gen :type elpa :version "0.4") (:name ProofGeneral :url "http://proofgeneral.inf.ed.ac.uk/releases/ProofGeneral-4.3pre130510.tgz" :build/darwin ("cd ProofGeneral && make clean")) (:name clojure-mode :type elpa :repo ("MELPA" . "http://melpa.milkbox.net/packages/")) (:name nrepl :type elpa :checkout "v0.1.7") (:name sml-mode :type elpa :version "6.4") (:name elisp-slime-nav :type elpa :checkout "0.5") (:name diminish :type elpa :version "0.44") (:name exec-path-from-shell :type elpa :checkout "1.2"))))
